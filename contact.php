		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12 col-xs-12 xol-sm-12 product-wrapper">
					...
					?>
						<h3 class="page-title"><span class="fa fa-envelope"> <?php echo $contact['title']; ?></h3>
						<div class="col-md-4 col-xs-12 no-padding contact">
							<img src="assets/images/contact-us.jpg" class="image-responsive">
						</div>
						<div class="col-md-4 col-xs-12">
							<?php echo $contact['content']; ?>
						</div>
						<div class="col-md-4 col-xs-12 no-padding contact">
							<img src="assets/images/contact-us-two.jpg" class="image-responsive">
						</div>
					<?php
						} 
					}
